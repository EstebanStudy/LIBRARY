...
from app.crud.crud_libro import get_libro, get_libros, create_libro, update_libro, delete_libro, buscar_libros
...
def read_libros(
    ...
    # Si hay parámetro de búsqueda, usar búsqueda
    if q:
        libros = buscar_libros(db, query=q, skip=skip, limit=limit)
    else:
