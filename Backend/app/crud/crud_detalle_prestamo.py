...
def delete_detalle(db: Session, detalle_id: int) -> dict:
    ...
    if db_detalle.Fecha_devolucion_real is None:
        raise HTTPException(status_code=400, detail="No se puede eliminar el detalle de préstamo si no ha sido devuelto")
